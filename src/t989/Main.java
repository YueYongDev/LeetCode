...
public class Main {
    ...
    public List<Integer> addToArrayForm(int[] A, int K) {
        ...
        for (int i = 0; i < A.length || i < l; i++) {
            if (i < A.length) t = K % 10 + A[A.length - i - 1] + jin;
            else t = K % 10 + jin;
            list.add(0, t % 10);
            jin = t / 10;
            K = K / 10;
        }
        if (jin > 0) list.add(0, jin);
        return list;
    }
}
